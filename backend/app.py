...
# -*- coding: utf-8 -*-
"""
Conversor Universal de Documentos - Versão Melhorada
Um conversor profissional que preserva melhor a estrutura original dos documentos
com detecção avançada de formatação e elementos estruturais.
